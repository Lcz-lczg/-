                ...
                <el-form :model="form" ref="formModel" :label-width="labelWidth" status-icon validate-on-rule-change>
                    <el-form-item
                        ...
                        :rules="[
                            ...
                            { validator: rule.checkRemote, message: '内容重复了', checktype: 'insert', module: 'jiaolian', col: 'gonghao', trigger: 'blur' },
                        ]"
                    >
...
<script setup>
    ...
    import { useJiaolianCreateForm, canJiaolianInsert } from "@/module";
    ...
    const { form } = useJiaolianCreateForm();
