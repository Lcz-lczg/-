                    ...
                    <div class="sn-content">
                        <form action="javascript:;" @submit="searchSubmit" class="form-search">
                            <table class="jd-search">
                                <tbody>
                                    <tr>
                                        <td class="label">球队名称</td>
                                        <td>
                                            <el-input type="text" style="width: 150px" v-model="search.qiuduimingcheng" placeholder="请输入关键词"> </el-input>
                                        </td>
                                    </tr>
                                    <tr>
                        ...
                        <el-row :gutter="30">
                            <el-col v-for="r in lists" :md="6" :key="r.id" style="margin-bottom: 20px">
                                <article class="single_product v-module-xiezi">
                                    <figure>
                                        <div class="product_thumb" @click="$goto('/qiudui/detail?id=' + r.id)">
                                            <div class="label_product"></div>
                                            <e-img class="primary_img" :src="r.qiuduitupian" pb="100" :is-scale="true" />
                                        </div>
                                        <figcaption class="product_content">
                                            <h4 class="product_name">
                                                <a href="javascript:;" @click="$goto('/qiudui/detail?id=' + r.id)"> {{ r.qiuduimingcheng }}</a>
                                            </h4>
                                            <div class="add_to_cart">
                                                <a href="javascript:;" title="查看详情" @click="$goto('/qiudui/detail?id=' + r.id)">查看详情</a>
                                            </div>
                                        </figcaption>
                                    </figure>
                                </article>
