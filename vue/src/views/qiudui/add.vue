<template>
    <div class="views-qiudui-add">
        <div>
            <el-card class="box-card">
                <template #header>
                    <div class="clearfix">
                        <span class="title"> 添加球队 </span>
                    </div>
                </template>

                <el-form :model="form" ref="formModel" :label-width="labelWidth" status-icon validate-on-rule-change>
                    <el-form-item label="球队编号 " prop="qiuduibianhao" :rules="[{ required: true, message: '请填写球队编号' }]"> <el-input type="text" placeholder="输入球队编号" style="width: 450px" v-model="form.qiuduibianhao" /> </el-form-item>
                    ...
                    <el-form-item
                        ...
                        :rules="[
                            ...
                            { validator: rule.checkRemote, message: '内容重复了', checktype: 'insert', module: 'qiudui', col: 'qiuduimingcheng', trigger: 'blur' },
                        ]"
                    >
...
<script setup>
    ...
    import { useQiuduiCreateForm, canQiuduiInsert } from "@/module";
    ...
    const { form } = useQiuduiCreateForm();
