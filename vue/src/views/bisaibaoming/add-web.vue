<template>
    <div class="views-bisaibaoming-web-add">
        <div>
            <e-container>
                <el-card class="box-card">
                    ...
                    <el-form :model="form" ref="formModel" :label-width="labelWidth" status-icon validate-on-rule-change>
                        ...
                        <el-form-item label="报名球队 " prop="baomingqiudui">
                            <div style="width: 100%">
                                <e-select-list :model="form" v-model="form.baomingqiudui" module="qiudui"
                                               select-update="qiuduibianhao,qiuduimingcheng,qiuduiduiyuan,jiaolianxingming,qiuduijiaolian" search-update=""
...
<script setup>
    ...
    function updateQuery(query){
        query.where('qiuduijiaolian',session('username'))
