<template>
    <div class="views-bisaibaoming-updt">
        <div>
                ...
                <el-form :model="form" ref="formModel" :label-width="labelWidth" status-icon validate-on-rule-change>
                    ...
                    <el-form-item label="状态 " prop="zhuangtai">
                        <el-select v-model="form.zhuangtai"
                            ...
                            <el-option label="已编排" value="已编排"></el-option>
                        </el-select>
                    </el-form-item>
...
<script setup>
    ...
    import { useBisaibaomingFindById, canBisaibaomingFindById, canBisaibaomingUpdate, canBisaixinxiFindById } from "@/module";
    ...
    const form = useBisaibaomingFindById(props.id);
    ...
    const submit = () => {
        formModel.value.validate().then((res) => {
            ...
            loading.value = true;
            canBisaibaomingUpdate(form).then(
                (res) => {
                    loading.value = false;
                    if (res.code == 0) {
