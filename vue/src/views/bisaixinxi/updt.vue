<template>
    <div class="views-bisaixinxi-updt">
        <div>
...
<script setup>
    ...
    import { useBisaixinxiFindById, canBisaixinxiFindById, canBisaixinxiUpdate } from "@/module";
    ...
    const form = useBisaixinxiFindById(props.id);
