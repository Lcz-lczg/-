...
<script setup>
    ...
    import { usePinglunFindById, canPinglunFindById, canPinglunUpdate } from "@/module";
    ...
    const form = usePinglunFindById(props.id);
