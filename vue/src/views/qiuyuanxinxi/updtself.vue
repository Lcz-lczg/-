<template>
    <div class="views-qiuyuanxinxi-updtself">
        <div>
            <el-card class="box-card">
                ...
                <el-form :model="form" ref="formModel" :label-width="labelWidth" status-icon validate-on-rule-change>
                    ...
                    <el-form-item label="所属球队 " prop="suoshuqiudui"> <el-input disabled type="text" placeholder="输入所属球队" style="width: 450px" v-model="form.suoshuqiudui" /> </el-form-item>
