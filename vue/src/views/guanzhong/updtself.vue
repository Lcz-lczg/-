<template>
    <div class="views-guanzhong-updtself">
        <div>
                ...
                <el-form :model="form" ref="formModel" :label-width="labelWidth" status-icon validate-on-rule-change>
                    <el-form-item
                        ...
                        :rules="[
                            ...
                            { validator: rule.checkRemote, message: '内容重复了', checktype: 'update', module: 'guanzhong', col: 'yonghuming', id: form.id, trigger: 'blur' },
                        ]"
                    >
...
<script setup>
    ...
    import { useGuanzhongFindById, canGuanzhongFindById, canGuanzhongUpdate } from "@/module";
    ...
    const form = useGuanzhongFindById(props.id);
