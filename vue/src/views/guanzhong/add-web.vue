<template>
    <div class="views-guanzhong-web-add">
        <div>
            <e-container>
                    ...
                    <el-form :model="form" ref="formModel" :label-width="labelWidth" status-icon validate-on-rule-change>
                        <el-form-item
                            ...
                            :rules="[
                                ...
                                { validator: rule.checkRemote, message: '内容重复了', checktype: 'insert', module: 'guanzhong', col: 'yonghuming', trigger: 'blur' },
                            ]"
                        >
...
<script setup>
    ...
    import { useGuanzhongCreateForm, canGuanzhongInsert } from "@/module";
    ...
    const { form } = useGuanzhongCreateForm();
