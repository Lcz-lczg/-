...
@Service
public class YouqinglianjieService {

    // 获取数据库操作类mapper
    @Resource
    private YouqinglianjieMapper mapper;

    /**
     *  根据id 获取一行数据
     */
    public R<Youqinglianjie> findById(Integer id) {
     ...
     *  根据Wrapper 对象进行数据筛选
     */
    public R<List<Youqinglianjie>> selectAll(Wrapper<Youqinglianjie> query) {
    ...
    public R<List<Youqinglianjie>> selectAll() {
        QueryWrapper<Youqinglianjie> wrapper = Wrappers.query();
    ...
    public R selectAll(Map<String, Object> map) {
        ...
        QueryWrapper<Youqinglianjie> wrapper = mapToWrapper(map);
        // 设置排序
     ...
     */
    public QueryWrapper<Youqinglianjie> mapToWrapper(Map<String, Object> map) {
        // 创建 QueryWrapper 对象
        QueryWrapper<Youqinglianjie> wrapper = Wrappers.query();
    ...
    public R selectPages(QueryWrapper<Youqinglianjie> wrapper, IPage page) {
     ...
     * @return 是否处理成功
     */
    public R insert(Youqinglianjie entityData, Map post) {
        // 判断是否有填写网站名称。
        if (StringUtil.isNullOrEmpty(post.get("wangzhanmingcheng"))) {
            return R.error("请填写网站名称");
        }
        // 判断是否有填写网址。
        if (StringUtil.isNullOrEmpty(post.get("wangzhi"))) {
     ...
     * @return 是否处理成功
     */
    public R<Object> update(Youqinglianjie entityData, Map post) {
        // 判断是否有填写网站名称。
        if (StringUtil.isNullOrEmpty(post.get("wangzhanmingcheng"))) {
            return R.error("请填写网站名称");
        }
